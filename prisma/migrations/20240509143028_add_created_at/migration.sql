/*
  ...
  - You are about to drop the column `categooryId` on the `Product` table. All the data in the column will be lost.
...
-- DropForeignKey
ALTER TABLE "Product" DROP CONSTRAINT "Product_categooryId_fkey";

-- AlterTable
ALTER TABLE "Category" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;

-- AlterTable
ALTER TABLE "Product" DROP COLUMN "categooryId",
DROP COLUMN "discontPercentage",
