...
CREATE TABLE "Product" (
    ...
    "discontPercentage" INTEGER NOT NULL DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_categooryId_fkey" FOREIGN KEY ("categooryId") REFERENCES "Category"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
